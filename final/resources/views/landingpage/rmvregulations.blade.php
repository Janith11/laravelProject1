...
<!-- start the main part -->
<div class="container bg-light mt-5 mb-5" id="maincontainer">
  <div class="card">
    <h4 class="card-header">RMV Regulations</h4>
    <div class="card-body">
...
<div class="mt-5 container mb-5">
  <div class="card">
    <h4 class="card-header">Vehicle category with category code</h4>
    <div class="card-body">
