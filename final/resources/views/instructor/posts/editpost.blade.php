...
<div class="container">
    ...
    <div class="row mb-2">
        ...
        <a style="padding-top: 6px; padding-left: 10px" href="{{ route('instructorpostlist') }}"> / All posts</a>
        ...
        <div id="card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="card">
                        <button class="btn btn-success" onclick="text()">Save Changes</button>
                    </div>
    ...
    <form action="{{ route('instructorupdatepost') }}" method="POST" style="display: none" id="form">
        @csrf
...
<script>
    ...
    $( document ).ready(function() {
        ...
        document.getElementById('sampleeditor').innerHTML = message;
    });
