...
<div class="container">
    ...
    <div class="row mb-2">
        ...
        <a style="padding-top: 6px; padding-left: 10px" > / This Month Leave Details</a>
    </div>
    ...
    <div class="row-mb-2">
        <div class="row justify-content-end">
            <div id="card" style="padding-right: 15px">
                <a href="{{ route('instructorallleavedetails') }}" class="btn btn-primary" type="button">All Leaves</a>
            </div>
        </div>
    </div>
    ...
    <div class="row-mb-2">
        <div id="card">
            <div class="card">
                <div class="card-body">
                    <h5 style="color: #222944; font-weight: bold">This Month Leave Details</h5>
