...
<div class="container">
    <div class="row mb-2">
        ...
        <a style="padding-top: 6px; padding-left: 10px"> / Students Details/ Categories</a>
    </div>
                ...
                <table class="table mt-3">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Training/ Not Training</th>
                    ...
                    <tbody>
                        ...
                        <form action="{{ route('addnewstudentcategory') }}" method="POST">
                            @csrf  
        ...
        <div class="card-body">
            <table class="table mt-3">
                ...
                <tbody>
                    ...
                    <form action="{{ route('updatestudentcategory',[$c->id, $c->user_id]) }}" method="POST">
                        @csrf  
                        <tr>
                        ...
                        <td>
                            <form method="POST" action="{{ route('deletestudentvehiclecategory', [$c->id, $c->user_id]) }}" id="delete-form-{{ $c->id }}" style="display: none">
                                @csrf
                                @method('delete')
                            </form>
