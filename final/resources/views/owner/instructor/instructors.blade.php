                ...
                @foreach($instructors as $instructor)
                    <div class="col-sm-3 mb-2">
                        <div class="card text-center">
                            <div class="gradient">
                                <img src="/uploadimages/instructors_profiles/{{ $instructor->user->profile_img }}" style="max-width: 100px; height: auto;" class="card-img-top mx-auto rounded-circle mt-3" alt="" id="image">
                            </div>
                            <div class="card-body">
                            ...
                            <h5 class="card-title">Contact : {{ $instructor->user->contact_number }}</h5>
