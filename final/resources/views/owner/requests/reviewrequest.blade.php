                    ...
                    @foreach ($registration as $r)
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4" id="register_form_item">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="firstname" class="form-control" id="fristname" placeholder="Enter Frist name ..." value="{{ $r->f_name }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4" id="register_form_item">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="middlename" class="form-control" id="middlename" placeholder="Enter Middle name ..." value="{{ $r->m_name }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4" id="register_form_item">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lastname" class="form-control" id="lastname" placeholder="Enter Last name ..." value="{{ $r->l_name }}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4" id="register_form_item">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nicnumber" class="form-control" id="nicnumber" placeholder="Enter Nic Number ..." value="{{ $r->nic_number }}" readonly>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col" id="register_form_item">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="gender" id="male" value="male" {{ $r->gender == 'male' ? 'checked' : '' }} readonly>
                                    ...
                                    <div class="col" id="register_form_item">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="gender" id="female" value="male" {{ $r->gender == 'female' ? 'checked' : '' }} readonly>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label >Address</label>
                                    <input type="text" name="addressnumber" class="form-control" id="addresslineone" placeholder="Address No ..." value="{{ $r->address_no }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="addressstreatname" class="form-control" id="addresslinetwo" placeholder="Street ..." value="{{ $r->address_lineone }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="addresscity" class="form-control" id="addresslinethree" placeholder="city ..." value="{{ $r->address_linetwo }}" readonly>
                                </div>
                            </div>
                        </div>
