...
<div class="container">
    ...
    <div class="row mb-2">
        ...
        <a style="padding-top: 6px; padding-left: 10px" href="{{ route('ownershedulelist') }}"> / Schedule List</a>
        <a style="padding-top: 6px; padding-left: 10px"> / Edit Schedule</a>
    </div>
    ...
    <div class="row-mb-2">
        <div id="card">
            <div class="card">
                <div class="card-body">
                    <h5 style="color: #010A30; font-weight: bold">Edit Schedule</h5>
                            ...
                            <div class="col-sm-3">
                                <div class="card h-100">
                                    <div class="card-body" style="border-left: 10px solid #2EFD6C">
                                        <div>
                                            <h5 style="color: #010A30; font-weight: bold">Schedule ID & Title</h5>
                                        </div>
                                        <div>
