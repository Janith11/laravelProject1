                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-3 text-right">
                                                                    <a tabindex="0" class="btn" role="button" data-toggle="popover" data-trigger="focus"  data-placement="left"  data-content='<ul class="list-group"><li  class="list-group-item list-group-item-action" id="modelitem"><a href="{{ route('viewdetails', $next_shedule->id) }}" type="button" id="modelbtn">details</a></li><li class="list-group-item list-group-item-action" id="modelitem"><a type="button" href="{{ route('cancelshedule', $next_shedule->id) }}" id="modelbtn">cancel</a></li><li class="list-group-item list-group-item-action" id="modelitem"><a type="button" id="modelbtn">postpond</a></li></ul>'>
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#222944" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                                                        <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
                                                                        </svg>
                                                                    </a>
