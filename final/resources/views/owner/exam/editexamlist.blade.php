...
<div class="container">
    <div class="row mb-2">
        ...
        <a style="padding-top: 6px; padding-left: 10px; text-decoration: none !important" href="{{ route('ownerexamresult') }}"> / Exam Results</a>
        <a style="padding-top: 6px; padding-left: 10px; text-decoration: none !important"> / Edit Exam Results</a>
    </div>
