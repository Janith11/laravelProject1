        ...
        <div class="row row-cols-1">
            ...
            <div class="col-sm-8">
                {{-- <div id="card"> --}}
                    <div class="card h-100">
                        <div class="card-body">
                            <h5 style="color: #080529; font-weight: bold">Training Sessions on {{ $select_date }}</h5>
    ...
    <div class="row-mb-2">
        <div id="card">
            <div class="card">
                <div class="card-body">
                    <div>
                        <button class="slotbtn btnone" onclick="btnone()">Choose a Daily Session</button>
                        <button class="slotbtn btntwo" onclick="btntwo()">Request a Special Session</button>
