                ...
                <!-- margin botton mb-5 added for the scroll testing -->
                    <li class="nav-item  mb-3 dashboard" id="nav-item">
                        <div style="padding-left: 10px">
                            ...
                            <div style="display: inline-block">
                                <a class="nav-link" href="{{ route('student.studentdashboad') }}">
                        ...
                        <div style="padding-left: 10px">
                            ...
                            <div style="display: inline-block">
                                <a class="nav-link" href="{{ route('myprogress') }}">
                                    <span class="menu-title" id="item">Progress</span>
                                </a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item  mb-3 payments" id="nav-item">
                        <div style="padding-left: 10px">
                            <div style="display: inline-block">
                                <img src="/uploadimages/other/dashboardicons/wallet.png" alt="" style="width: 20px; height: auto; padding-bottom: 5px;">
                            </div>
                            <div style="display: inline-block">
                                <a class="nav-link" href="{{ route('studenentpaymentlogsview') }}">
                                    ...
                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div>
                                            ...
                                            <div style="display: inline-block; float:right">
                                                <img src="/uploadimages/students_profiles/{{ Auth::user()->profile_img }}" alt="Profile Image" class="rounded-circle border border-dark" style="width: 30px; height: auto;" >
                                            </div>
                                        </div>
                                    </a>
