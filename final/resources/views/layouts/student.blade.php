...
<body style="background-color: #ffffff;">
   <div>
        ...
        <div class="slimscroll-menu" id='sidebar'>
            ...
            <ul>
                ...
                <li class="nav-item  mb-3" id="nav-item">
                    <a class="nav-link" href="{{ route('student.studentdashboad') }}"><i><img src="images/dashboard.png" alt=""></i>
    ...
    <!-- header -->
    <header style="background-color: #ffffff ;" class="shadow">
                ...
                <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre style="padding-right: 20px; font-size: 20px; font-family: Heebo, sans-serif;">
                                    {{ Auth::user()->f_name }}
