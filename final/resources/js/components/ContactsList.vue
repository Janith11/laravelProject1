        ...
        <ul class="list-group mt-1">
            <li class=" d-flex justify-content-between align-items-center p-1  m-0" v-for="contact in sortedContacts" :key="contact.id" @click="selectContact(contact)" :class="{'selected': contact==selected}">
                ...
                <div class="avatar col float-left">
                    <img v-if="contact.role_id == 3" class="rounded-circle border border-success" v-bind:src="'/uploadimages/students_profiles/'+contact.profile_img" alt="">
                    <img v-if="contact.role_id == 2" class="rounded-circle border border-success" v-bind:src="'/uploadimages/instructors_profiles/'+contact.profile_img" alt="">
                </div>
