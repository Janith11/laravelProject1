...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'role_id','f_name', 'm_name','l_name', 'password', 'nic_number', 'gender', 'contact_number', 'contact_no_isVerified','otp','dob', 'address_no', 'address_lineone', 'address_linetwo', 'profile_img', 'status'
    ];
